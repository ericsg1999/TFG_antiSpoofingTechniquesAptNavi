function [eph, TOW] = ephemeris(bits, D30Star,settings)
...
%% NAVI TOW spoofing detection check
% if settings.naviTowActive==1
%     naviTowDetectionResult=naviTowSpoofingDetection(fiveTowFrame);
%     disp('NAVI TOW non-coherent in subframe X: Possible Spoofing attack')
% end
